...
- **Status:** Accepted (owner: Emanuele, 2026-07-10)
...
- The single-doc ingest prohibition on synthesis/comparison/query as free provider output is retained (asserted in tests).
