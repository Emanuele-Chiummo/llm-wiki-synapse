...
/**
 * M5_ITEMS — Deep Search (F10) and Review (F9) are active.
 * Search and Lint remain as placeholders until their phases land.
 * i18n keys nav.search / nav.lint / nav.comingSoon retained.
 */
