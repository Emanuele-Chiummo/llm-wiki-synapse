...
def _build_meta() -> MetaData:
    ...
    Table(
        ...
        Column("x", Float, nullable=True),  # v0.3 FR coord
        Column("y", Float, nullable=True),  # v0.3 FR coord
        Column("community", Integer, nullable=True),  # G-P0-2: Louvain community id
        Column("pinned", Integer, nullable=False, server_default="0"),  # Feature A
    ...
    Table(
        ...
        Column("remote_mcp_enabled", Integer, nullable=False, server_default="0"),
        Column("mcp_access_token_hash", Text, nullable=True),
        Column("mcp_allow_without_token", Integer, nullable=False, server_default="0"),
