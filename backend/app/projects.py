...
# ── Models ─────────────────────────────────────────────────────────────────────
# Project / ProjectsResponse / read_registry / write_registry now live in
# app/project_registry.py (pure, no app.main dependency — see that module's
# docstring for why) and are re-exported above for backward compatibility.
