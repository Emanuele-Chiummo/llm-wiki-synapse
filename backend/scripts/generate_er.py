...
def generate_mermaid_er() -> str:
    ...
    # No timestamp in the header: the CI docs gate diffs the regenerated file,
    # so output must be byte-identical regardless of the day it runs (I8).
    header = "%% Generated by scripts/generate_er.py — do not edit by hand (make er)"
