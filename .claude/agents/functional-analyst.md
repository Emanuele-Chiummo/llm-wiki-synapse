...
description: Use to translate feature IDs (K*/F*) into user stories, acceptance criteria, and a traceability matrix (docs/process/TRACEABILITY.md). MUST BE USED at the start of every sprint, after product-manager locks scope.
...
- Maintain docs/process/TRACEABILITY.md: feature ID → user stories → acceptance criteria → test IDs
...
Definition of Done: docs/process/TRACEABILITY.md updated with all in-scope IDs; user stories and
...
ai-agent-engineer; docs/process/TRACEABILITY.md stub → qa-test-engineer to fill test IDs.
